...
import MaxHeightFromTimeToMaxHeight from "./MaxHeightFromTimeToMaxHeight";
import MaxHeightFromVelocityAndAngle from "./MaxHeightFromVelocityAndAngle";
    ...
    return (
        <Tabs>
            <Tabs.TabPane tab="From Max Height and Time" key="max-height-time">
                <MaxHeightFromVelocityAndAngle />
            </Tabs.TabPane>
            <Tabs.TabPane tab="From Time and Velocity" key="time-velocity">
                <MaxHeightFromTimeToMaxHeight />
            </Tabs.TabPane>
        </Tabs>
    );
}

export default MaxHeightForm;
